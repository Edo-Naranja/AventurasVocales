...
{	
	...
	public class SkyTheoryLevelManager : LevelManager
	{
		...
		protected override void Start()
		{
	        ...
	        CurrentPlayableCharacters[0].GetComponent<Rigidbody2D>().bodyType = RigidbodyType2D.Kinematic;
	    ...
	    {
			base.LevelStart();
			CurrentPlayableCharacters[0].GetComponent<Rigidbody2D>().bodyType = RigidbodyType2D.Dynamic;
	    }
