...
namespace MoreMountains.InfiniteRunnerEngine
{
	public class Instructions : MonoBehaviour
	{
		...
		[Tooltip("the gameobject that will display the actual text")]
		...
		[Tooltip("how long will the instructions be displayed (in seconds) ?")]
		public int Duration;

		/// how long does it take for the instructions to fade out ? (in seconds)
		[Tooltip("how long does it take for the instructions to fade out ? (in seconds)")]
