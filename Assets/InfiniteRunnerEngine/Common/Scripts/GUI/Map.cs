...
namespace MoreMountains.InfiniteRunnerEngine
{
	...
	public class Map : MMSingleton<Map>
	{
		...
		[Tooltip("The particle system that signals what level is currently selected")]
		public ParticleSystem ActiveLevelParticleEmitter;

		/// The text object that will actually display the 
		[Tooltip("The text object that will actually display the ")]
