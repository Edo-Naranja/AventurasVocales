	...
	public class LevelManagerEditor : Editor
	{
		...
		static void DrawGameObjectName(LevelManager levelManager, GizmoType gizmoType)
		{
			...
			if (levelManager.RecycleBounds.size != Vector3.zero)
			{
				...
				v3FrontTopLeft = new Vector3(levelManager.RecycleBounds.center.x - levelManager.RecycleBounds.extents.x,
					levelManager.RecycleBounds.center.y + levelManager.RecycleBounds.extents.y + 1,
					levelManager.RecycleBounds.center.z -
					levelManager.RecycleBounds.extents.z); // Front top left corner
			...
			if (levelManager.DeathBounds.size != Vector3.zero)
			{
				...
				v3FrontTopLeft = new Vector3(levelManager.DeathBounds.center.x - levelManager.DeathBounds.extents.x,
					levelManager.DeathBounds.center.y + levelManager.DeathBounds.extents.y + 1,
					levelManager.DeathBounds.center.z - levelManager.DeathBounds.extents.z); // Front top left corner
