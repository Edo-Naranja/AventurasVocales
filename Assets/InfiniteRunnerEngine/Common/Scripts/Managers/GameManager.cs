...
namespace MoreMountains.InfiniteRunnerEngine
{
	...
	public class GameManager : MMSingleton<GameManager>
	{
		...
		[Tooltip("the number of lives the player gets (you lose a life when your character (or your characters all) die. lose all lives you lose the game and your points.")]
		...
		[Tooltip("the current time scale")]
		...
		{
			Status = newStatus;
			if (GameManagerInspectorNeedRedraw != null)
			{
