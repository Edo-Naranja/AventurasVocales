...
namespace MoreMountains.InfiniteRunnerEngine
{
	...
	{
		[Space(10)] [Header("Spawn Timing")]
		/// the minimum interval (in seconds) between 2 spawns
		[Tooltip("the minimum interval (in seconds) between 2 spawns")]
		public float MinSpawnTime = 0.5f;

		/// the maximum interval (in seconds) between 2 spawns
		[Tooltip("the maximum interval (in seconds) between 2 spawns")]
		public float MaxSpawnTime = 2f;

		[Space(10)] [Header("Position")]
		/// the minimum position of the object
		[Tooltip("the minimum position of the object")]
		public Vector3 MinPosition;

		/// the maximum position of the object
		[Tooltip("the maximum position of the object")]
