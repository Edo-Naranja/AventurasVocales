...
namespace MoreMountains.InfiniteRunnerEngine
{
	...
	public class ScenarioEvent
	{
		...
		[Tooltip("Is this scenario event triggered when a certain time is reached, or when a certain score is reached ?")]
		public ScenarioEventTypes ScenarioEventType;

		/// the time in seconds at which this event should be triggered
		[Tooltip("the time in seconds at which this event should be triggered")]
		public float StartTime;

		/// the score at which this event is triggered
		[Tooltip("the score at which this event is triggered")]
		public float StartScore;

		/// if true, this event will be triggered by the RunScenario method, then put to false
		[Tooltip("if true, this event will be triggered by the RunScenario method, then put to false")]
		public bool Status;

		/// the name of the MMEvent to trigger
		[Tooltip("the name of the MMEvent to trigger")]
		public string MMEventName;

		/// the action to trigger
		[Tooltip("the action to trigger")]
		...
		public ScenarioEvent(float startScore, float startTime, Action scenarioEventAction, string eventName,
